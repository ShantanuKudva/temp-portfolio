...
export const CAM_POS: Keyframe<Tuple3>[] = [
  ...
  { at: BEAT.constellStart,  value: [0, 1.12, 2.4], ease: 'inOutCubic' },    // pulled back to frame the whole constellation w/ margin
  { at: BEAT.constellPeak,   value: [0, 1.12, 2.45], ease: 'inOutCubic' },   // holds on the full network map
  { at: BEAT.holdStart,      value: [0, 1.1, 2.4], ease: 'inOutCubic' },     // gentle creep
